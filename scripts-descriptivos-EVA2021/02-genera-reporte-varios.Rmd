---
title: "EVA 2021 - Reporte descriptivo de los cuestionarios de factores asociados"
...
output:
 pdf_document:
  ...
  toc_depth: 3
params:
  cuest: "EVA2021_2Sdirector_EBRG1"
...
files <- list.files(
  path = here("3-reportes", "1-descriptivos", "2-con-pesos", "0-figuras"),
  pattern = "*.pdf",
  full.names = TRUE)

bd <- filter(tabla3, estrato == "General") %>%
...
cuestionarios aplicados a directores, docentes, estudiantes y padres de familia en el marco del estudio 
EVA 2021.

Los cuestionarios de la EVA 2021 contaron con un conjunto de preguntas que consideraron tanto
